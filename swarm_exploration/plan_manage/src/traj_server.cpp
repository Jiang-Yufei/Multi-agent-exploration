...
ros::Publisher cmd_vis_pub, pos_cmd_pub, traj_pub, swarm_pos_cmd_pub;
;
...
void cmdCallback(const ros::TimerEvent& e) {
  ...
  ROS_WARN_THROTTLE(1.0, "Drone %d, [%lf,%lf,%lf,%lf], [time, length, vel, energy]", drone_id_,
